...
export const productListDoors = [
    ...
    [
        {
            ...
            information: 'Регулируется в трех направлениях. Крепится к профилю при помощи закладных. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 24 шт.'
        },
        {
            id: 2,
            groupId: 0,
            ...
            information: 'Крепится к профилю при помощи закладных. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 24 шт.'
        }
    ],
    [
        {
            ...
            img: img3,
            description: 'Трехсекционная подшипниковая петля предназначена для установки на алюминиевые двери.',
            information: 'Регулируется в трех направлениях. Крепится к профилю при помощи закладных. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 16 шт.'
        },
        {
            id: 4,
            groupId: 0,
            ...
            img: img3,
            description: 'Трехсекционная втулочная петля предназначена для установки на алюминиевые двери.',
            information: 'Регулируется в трех направлениях. Крепится к профилю при помощи закладных. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 16 шт.'
        }
    ],
    {
    ...
    /* Ручки бугельные */
    {
        ...
        img: img8,
        description: 'Предназначены для установки на двери из алюминиевого и ПВХ профиля толщиной от 40мм до 80мм.',
        information: 'Диаметр сечения 30мм. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 6шт.'
    },
    /* Нажимные гарнитуры */
    {
        id: 10,
        ...
        img: img9,
        description: 'Предназначен для установки на двери из алюминиевого и ПВХ профиля толщиной от 42мм до 75мм.',
        information: 'RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 12 шт.'
    },
    {
        id: 11,
        groupId: 0,
...
export const productListWindows = [
    ...
    },
    {
        ...
        img: img12,
        description: 'Используется для соединения импоста и оконных рам, створок.',
    ...
    },
    {
        ...
        img: img13,
        description: 'Используется для соединения импоста и дверных рам, створок.',
        information: 'Упаковка: 120 шт.'
    },
    {
        id: 15,
    ...
    /* Петли */
    {
        ...
        information: 'Крепится винтами к закладным элементам. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ . Упаковка: 96 шт.'
    },
    {
        id: 20,
        groupId: 1,
        ...
        img: img19,
        description: 'Предназначена для установки на легкие алюминиевые двери. ',
        information: 'Крепится винтами к закладным элементам. RAL 9016 в наличии, н/о в наличии, любой другой цвет под заказ. Упаковка: 96 шт.'
    },
];
